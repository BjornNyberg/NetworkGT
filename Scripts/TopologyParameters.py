...
def main (nodes,branch,infc3,output,output2,units):
	...
	if 'shp' in output2:
        ...
        temp_csv1 = os.path.join(os.path.dirname(output2),'temp_csv1.csv')  #Create temp csv files to handle geodatabase files
        temp_csv2 = os.path.join(os.path.dirname(output2),'temp_csv2.csv') 
